...
def wiener_filter_streaming(x, fs):
    # noisy speech FFT
...
if __name__=='__main__':
    # input wave file
    f = wave.open('/Users/musk/dataset/VADTestSet/noisy/-2dB/G07FM0210082_h_babble.wav')
    # f = wave.open('/Users/musk/Userfile/compal/助聽器2.0/hearing aid recording/noisy_16k.wav')
    ...
    # wiener filter
    xfinal, winGain = wiener_filter_streaming(x, fs)

    # save wave file
    wf = wave.open('/Users/musk/Desktop/test.wav', 'wb')
